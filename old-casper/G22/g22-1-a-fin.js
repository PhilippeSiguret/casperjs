...
casper.thenOpen('https://www.linkedin.com/vsearch/p?f_CC=1058&trk=rr_connectedness&rsid=3468639261404248538393&f_G=fr%3A0&orig=FCTD&openFacets=N,G,CC,FA,SE&f_SE=2,1,3,4,5&f_FA=11', function() {
...
casper.then(function(){
	...
	// il faut mettre le nombre de contact dans l'URL de recherche/10. Il ne faut pas que ça dépasse, 
	// car sinon ça plante et ça n'écrit pas les résultats 
    for (var i = 2; i<4; i++) {
